 ...
 * @author group8
 */
public class EatAtMiddleStrategy extends EatAtPositionStrategy {

    public EatAtMiddleStrategy(List<FamilyMember> family, List<Animal> animals, PlayerState state, Random random) {
    ...
    protected Point pickAPosition() {
        ...
        return new Point((MAX_X+MIN_X)/2, (MIN_Y+MAX_Y)/2);
    }
